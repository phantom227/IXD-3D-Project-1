...
#define LED_COUNT 2            // This is the only major change I made in this code is testing it out
                               // with two NeoPixels!!
...
void setup() {
  ...
  strip.setBrightness(60);    // Sets the BRIGHTNESS
...
//   colorWipe(strip.Color(0, 0, 45), 100); // Blue
  ...
  // Fills the NeoPixels with a strip of various colors:
   colorWipe(strip.Color(random(255), random(255), random(255)), 100);                  // randomized array of color
